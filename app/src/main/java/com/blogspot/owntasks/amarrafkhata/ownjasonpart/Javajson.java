...
public class Javajson extends AppCompatActivity {
    ...
    String HTTP_SERVER_URL = "http://192.168.0.104/newsappapi/java/Details.php";
    View ChildView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() {
            GestureDetector gestureDetector = new GestureDetector(Javajson.this, new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onInterceptTouchEvent(RecyclerView Recyclerview, MotionEvent motionEvent) {
                ...
                if (ChildView != null && gestureDetector.onTouchEvent(motionEvent)) {
                    ...
                    Toast.makeText(Javajson.this, SubjectNames.get(RecyclerViewClickedItemPOS), Toast.LENGTH_LONG).show();
                }
                return false;
            }
            @Override
