...
public class Datasre extends AppCompatActivity {
    ...
    String HTTP_SERVER_URL = "http://192.168.0.104/newsappapi/datastruc/Details.php";
    View ChildView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_datasre);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() {
            GestureDetector gestureDetector = new GestureDetector(Datasre.this, new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onInterceptTouchEvent(RecyclerView Recyclerview, MotionEvent motionEvent) {
                ...
                if (ChildView != null && gestureDetector.onTouchEvent(motionEvent)) {
                    ...
                    Toast.makeText(Datasre.this, SubjectNames.get(RecyclerViewClickedItemPOS), Toast.LENGTH_LONG).show();
                }
                return false;
            }
